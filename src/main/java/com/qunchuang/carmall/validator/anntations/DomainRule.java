package com.qunchuang.carmall.validator.anntations;


import cn.wzvtcsoft.validator.core.DomainRuleValidator;
...
/**
 * 该注解是为了在该注解的作用范围内(即 方法参数与 属性中)取代 @Valid
 * <p>
...
public @interface DomainRule {
     ...
     * User{
     *
     * @Length(min = 6,max = 24)  private String username;
     * @Email private String email;
     * @Length(min = 6,max = 24)private String password;
     * }
     * </p>
     *
     * <p>
