...
public class PaginatorFactory {
    ...
    public List<String> getPaginator(TypedQuery typedQuery, Paginator pageInformation) {
        ...
        final QueryParameters queryParameters = ((QueryImpl) typedQuery.unwrap(QueryImplementor.class)).getQueryParameters().createCopyUsing(rowSelection);
        //预编译
    ...
    private QueryTranslatorImpl getQueryTranslator(TypedQuery typedQuery) {
        QueryImpl queryImpl = typedQuery.unwrap(QueryImpl.class);
