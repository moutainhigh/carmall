...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/getWxShareInfo","/getWxAuthentication", "/login/weChatMini", "/graphql", "/login/phone", "login/web", "/login/app", "/sts", "/getCode", "/jsapisignature", "/initAccount").permitAll()
